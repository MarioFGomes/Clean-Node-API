...
import { type HttpRequest, type IValidation, type IAuthentication, type AuthenticationModel } from './login-controller-protocols'
...
describe('Login Controller', () => {
  test('should call authenticator with correct email and password', async () => {
    ...
    expect(SpyAuth).toHaveBeenCalledWith({ email: 'any_email@mail.com', password: 'any_password' })
  })
